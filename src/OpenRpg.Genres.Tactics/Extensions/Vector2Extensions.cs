...
namespace OpenRpg.Genres.Tactics.Extensions
{
    public static class Vector2Extensions
    {
        ...
        public static int GetDirection(this Vector2 directionVector)
        {
            ...
            return directionVector.Y > 0 ? DirectionTypes.Down : DirectionTypes.Up;
        }

        public static int GetDirectionTo(this Vector2 position, Vector2 targetPosition)
        {
            var newDirection = Vector2.Normalize(targetPosition - position);
            return newDirection.GetDirection();
        }
