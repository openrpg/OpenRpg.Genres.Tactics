...
namespace OpenRpg.Tactics.Extensions
{
    public static class StatsExtensions
    {
        ...
        { return (int)stats.GetVariable(TacticsStatsVariableTypes.Initiative); }
        ...
        { return (int)stats.GetVariable(TacticsStatsVariableTypes.Experience); }
        ...
        {
            var currentExperience = stats.GetVariable(TacticsStatsVariableTypes.Experience);
